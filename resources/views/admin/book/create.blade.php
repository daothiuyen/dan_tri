        ...
        <div class="table-content pl-4 pr-4">
            ...
            <div class="form-input bg-light">
                <form>
                    ...
                    <div class="form-group pt-3">
                        <label for="author-form">Tác giả</label>
                        <input type="text" class="form-control" id="author-form" placeholder="Nhập tiêu đề">
                    </div>
                    ...
                    <div class="form-group pt-3">
                        <label for="pub-date">Ngày phát hành</label>
