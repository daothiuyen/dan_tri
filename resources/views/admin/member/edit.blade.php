            ...
            <div class="form-input bg-light">
                <form>
                    <div class="form-group pt-3">
                        ...
                        <input type="text" class="form-control" id="title" placeholder="Nhập họ tên">
                    </div>
                    ...
                    <div class="form-group pt-3">
                        ...
                        <input type="text" class="form-control" id="title" placeholder="Nhập chức vụ">
                    </div>
